...
const StorageMonitorGroupHandler = require('./storageMonitorGroupHandler.js');
...
module.exports = {
    inGameCommandHandler: async function (rustplus, client, message) {
        ...
        if (!rustplus.isOperational) {
            ...
            if (await StorageMonitorGroupHandler.storageMonitorGroupCommandHandler(rustplus, client, command)) {
                rustplus.logInGameCommand('Storage Monitor Group', message);
                return true;
            }
